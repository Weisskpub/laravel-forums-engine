...
class LFEDatabaseSeeder extends Seeder
{
	...
	public function run()
	{
		...
		\DB::table('lfe_forums')->insert([
			...
			['id' => 5,'parent_id' => 2,'title' => 'Subforum 1/1','description' => 'Normal forum under Forum-Category 1','keywords' => 'h-zone, Laravel, Forum, Engine','is_category' => false,'is_active' => true,'rank' => 100,'user_id' => null,'topic_id' => null,'post_id' => null,,'created_at' => '2016-11-21 22:20:00','updated_at' => '2016-11-21 22:20:00','updated_by'=>1,],
